<footer class="site-footer">
    <div class="site-footer_farm_image"><img src="images/resources/site-footer-farm.png"
                                             alt="Farm Image"></div>
    <div class="container">
                    ...
                    <ul class="footer-widget__news list-unstyled">
                        <li>
                            <div class="footer-widget__news_image">
                                <img src="images/resources/footer-1-img-1.jpg" alt="">
                            </div>
                        ...
                        <li>
                            <div class="footer-widget__news_image">
                                <img src="images/resources/footer-1-img-2.jpg" alt="">
                            </div>
                            <div class="footer-widget__news_text">
